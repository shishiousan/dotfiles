...
globalkeys = my_table.join(
	...
	awful.key({ modkey }, "p", function()
		menubar.show()
	end, { description = "show the menu bar", group = "hotkeys" }),
	-- Function keys
	...
	awful.key({ modkey }, "t", function()
		awful.util.spawn(terminal2)
	end, { description = "wezterm", group = "super" }),
	...
	-- some alt + ctrl + keys are removed
	...
	-- ctrl + shift + are removed (for mpc)
